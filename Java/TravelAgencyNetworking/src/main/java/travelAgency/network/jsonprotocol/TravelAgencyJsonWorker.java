...
public class TravelAgencyJsonWorker implements Runnable, ITravelAgencyObserver {
    ...
    public TravelAgencyJsonWorker(ITravelAgencyServices server, Socket connection) {
        this.server = server;
