...
import servicesAMS.ITravelAgencyClient;
...
public class TravelAgencyServerAMSRpcProxy implements ITravelAgencyServicesAMS {
    private String host;
    private int port;
    private ITravelAgencyClient client;
    ...
    public TravelAgencyServerAMSRpcProxy(String host, String port) {
        this.host = host;
    ...
    private void initializeConnection() throws TravelAgencyException {
        try {
            gsonFormatter = new GsonBuilder()
                    .registerTypeAdapter(LocalDateTime.class, new TravelAgencyServerAMSRpcProxy.LocalDateTimeTypeAdapter())
                    .create();
    ...
    private void startReader() {
        Thread newThread = new Thread(new TravelAgencyServerAMSRpcProxy.ReaderThread());
        newThread.start();
    }
    ...
    @Override
    public void login(User user) throws TravelAgencyException {
