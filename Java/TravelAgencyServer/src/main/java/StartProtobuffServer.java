...
import travelAgency.network.utils.TravelAgencyProtobuffConcurrentServer;
...
import travelAgency.persistence.repository.jdbc.UsersDbHibernateRepository;
...
public class StartProtobuffServer {
    ...
    public static void main(String[] args) {
        ...
        UsersDbHibernateRepository usersDbHibernateRepository = new UsersDbHibernateRepository();
        ...
        ITravelAgencyServices travelAgencyServices = new TravelAgencyServicesImplementation(usersDbHibernateRepository, tripRepository, reservationRepository);
        ...
        AbstractServer server = new TravelAgencyProtobuffConcurrentServer(travelAgencyServerPort, travelAgencyServices);
