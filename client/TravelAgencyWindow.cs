...
namespace client
{
    public partial class TravelAgencyWindow : Form
    {
        ...
        public TravelAgencyWindow(TravelAgencyClientController ctrl, User user)
        {
            Console.WriteLine(@"Initializing window for user: {0}", user.Username);
            _controller = ctrl;
            _currentUser = user;
            InitializeComponent();
            _trips = new List<Trip>(_controller.GetAllTrips());
        ...
        private void InitDataGridViewForSearchedTrips(Trip[] searchedTrips)
        {
        ...
        private void UpdateDataGridViewTrips(DataGridView dataGridView, List<Trip> newData)
        {
        ...
        public delegate void UpdataDataGridViewTripsCallback(DataGridView dataGridView, List<Trip> trips);
